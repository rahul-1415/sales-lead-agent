...
class XetProgressReporter:
    ...
    def update_progress(
        ...
        self.data_processing_bar.total = (
            self._total_bytes_offset + total_update.total_bytes
        )
        total_files_count = (
        ...
        self.upload_bar.total = (
            self._total_transfer_bytes_offset + total_update.total_transfer_bytes
        )
