        ...
        results.append(
            {
                ...
                "framework": (
                    model.get("framework", "") if isinstance(model, dict) else ""
                ),
                "instance": (
                    compute.get("instanceType", "") if isinstance(compute, dict) else ""
                ),
                "vendor": (
                    provider.get("vendor", "") if isinstance(provider, dict) else ""
                ),
                "region": (
                    provider.get("region", "") if isinstance(provider, dict) else ""
                ),
            }
        )
