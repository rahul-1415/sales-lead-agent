...
class BaseSettings(BaseModel):
    ...
    def __init__(
        ...
        _build_sources: (
            tuple[tuple[PydanticBaseSettingsSource, ...], dict[str, Any]] | None
        ) = None,
        **values: Any,
    ) -> None:
        sources, init_kwargs = (
    ...
    def _settings_init_sources(
        ...
        **init_kwargs: dict[str, Any],
        ...
        env_prefix = (
            ...
            else cls.model_config.get("env_prefix")
        )
        env_prefix_target = (
            _env_prefix_target
        ...
        cli_prefix = (
            ...
            else cls.model_config.get("cli_prefix")
        )
...
class CliApp:
    ...
    def run_subcommand(
        ...
        subcommand_arg = cli_settings_source._parser_map[subcommand_dest][
            subcommand_cls
        ]
