...
class Runnable(ABC, Generic[Input, Output]):
    ...
    **`RunnableParallel`** invokes runnables concurrently, providing the same input
    ...
    def _batch_with_config(
        self,
        func: (
            Callable[[list[Input]], list[Exception | Output]]
            | Callable[
    ...
    async def _abatch_with_config(
        self,
        func: (
            Callable[[list[Input]], Awaitable[list[Exception | Output]]]
            | Callable[
...
class RunnableGenerator(Runnable[Input, Output]):
    ...
    def __init__(
        ...
        atransform: (
            Callable[[AsyncIterator[Input]], AsyncIterator[Output]] | None
        ) = None,
        *,
        name: str | None = None,
    ) -> None:
...
class RunnableBindingBase(RunnableSerializable[Input, Output]):  # type: ignore[no-redef]
    ...
    def __init__(
        ...
        *,
        ...
        config: RunnableConfig | None = None,
        config_factories: (
            list[Callable[[RunnableConfig], RunnableConfig]] | None
        ) = None,
