    ...
    *,
    ...
    try:
        ...
        if downsample_fps and max_video_tokens is not None and video_config is not None:
            ...
            min_video_pixels, max_video_pixels, video_pixel_to_token_ratio = (
                video_config
            )
        ...
        x264_params = "bframes=0:ref=1:cabac=0:weightp=0:deblock=0,0:scenecut=0:keyint=60:min-keyint=60"
        ...
        try:
            ...
            if hasattr(e, "stderr"):
                ...
                raise VideoProcessingError(
                    f"ffmpeg optimization failed: {decoded}"
                ) from e
            raise
